...
def dump_all_scores(dumpfile, scores, sorted_scores, seq):
	with open(dumpfile, "w") as fh:
		dump_scores(scores, fh, seq)
		dump_scores(sorted_scores, fh, seq)
	return
...
too_close = []
exclusions = []
dump_all_scores(dumpfile, scores, sorted_scores, gly)
