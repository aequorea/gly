...
# position n and n+2. We exclude prolines from n-2 to n+2.


infile = "eyfp.fas"
outfile = "eyfp.gl1"		# first version output
num_sites = 5				# desired number of glycosylation sites
exclusions = [146, 8]		# mutation sites to disallow
